...
proc create_root_design { parentCell frequency } {
...
CONFIG.WUSER_WIDTH {0} \
  ...
  set_property -dict [ list \
CONFIG.ASSOCIATED_BUSIF {S_AXI_HP0:M_AXI_GP0:S_AXI_HP3:S_AXI_HP2:S_AXI_HP1} \
 ] $FCLK_CLK0
...
CONFIG.PCW_FPGA0_PERIPHERAL_FREQMHZ $frequency \
...
CONFIG.NUM_MI {1} \
  ...
  connect_bd_intf_net -intf_net S_AXI_HP1_1 [get_bd_intf_ports S_AXI_HP1] [get_bd_intf_pins processing_system7_1/S_AXI_HP1]
  connect_bd_intf_net -intf_net S_AXI_HP2_1 [get_bd_intf_ports S_AXI_HP2] [get_bd_intf_pins processing_system7_1/S_AXI_HP2]
  connect_bd_intf_net -intf_net S_AXI_HP3_1 [get_bd_intf_ports S_AXI_HP3] [get_bd_intf_pins processing_system7_1/S_AXI_HP3]
  ...
  connect_bd_net -net processing_system7_1_FCLK_CLK0 [get_bd_ports FCLK_CLK0] [get_bd_pins processing_system7_1/FCLK_CLK0] [get_bd_pins processing_system7_1/M_AXI_GP0_ACLK] [get_bd_pins processing_system7_1/S_AXI_HP0_ACLK] [get_bd_pins processing_system7_1/S_AXI_HP1_ACLK] [get_bd_pins processing_system7_1/S_AXI_HP2_ACLK] [get_bd_pins processing_system7_1/S_AXI_HP3_ACLK] [get_bd_pins processing_system7_1_axi_periph/ACLK] [get_bd_pins processing_system7_1_axi_periph/M00_ACLK] [get_bd_pins processing_system7_1_axi_periph/S00_ACLK] [get_bd_pins rst_processing_system7_1_50M/slowest_sync_clk]
  ...
  create_bd_addr_seg -range 0x40000000 -offset 0x00000000 [get_bd_addr_spaces S_AXI_HP1] [get_bd_addr_segs processing_system7_1/S_AXI_HP1/HP1_DDR_LOWOCM] SEG_processing_system7_1_HP1_DDR_LOWOCM
  create_bd_addr_seg -range 0x40000000 -offset 0x00000000 [get_bd_addr_spaces S_AXI_HP2] [get_bd_addr_segs processing_system7_1/S_AXI_HP2/HP2_DDR_LOWOCM] SEG_processing_system7_1_HP2_DDR_LOWOCM
  create_bd_addr_seg -range 0x40000000 -offset 0x00000000 [get_bd_addr_spaces S_AXI_HP3] [get_bd_addr_segs processing_system7_1/S_AXI_HP3/HP3_DDR_LOWOCM] SEG_processing_system7_1_HP3_DDR_LOWOCM

  # Perform GUI Layout
  regenerate_bd_layout -layout_string {
   guistr: "# # String gsaved with Nlview 6.5.12  2016-01-29 bk=1.3547 VDI=39 GEI=35 GUI=JA:1.6
#  -string -flagsOSRD
preplace port S_AXI_HP1 -pg 1 -y 340 -defaultsOSRD
preplace port DDR -pg 1 -y 280 -defaultsOSRD
preplace port S_AXI_HP2 -pg 1 -y 360 -defaultsOSRD
preplace port S_AXI_HP3 -pg 1 -y 380 -defaultsOSRD
preplace port FCLK_RESET0_N -pg 1 -y 340 -defaultsOSRD
preplace port M_AXI_GP0 -pg 1 -y 160 -defaultsOSRD
preplace port FIXED_IO -pg 1 -y 300 -defaultsOSRD
preplace port FCLK_CLK0 -pg 1 -y 320 -defaultsOSRD
preplace port S_AXI_HP0 -pg 1 -y 320 -defaultsOSRD
preplace inst processing_system7_1 -pg 1 -lvl 1 -y 360 -defaultsOSRD
preplace inst processing_system7_1_axi_periph -pg 1 -lvl 2 -y 160 -defaultsOSRD
preplace inst rst_processing_system7_1_50M -pg 1 -lvl 1 -y 90 -defaultsOSRD
preplace netloc S_AXI_HP0_1 1 0 1 NJ
preplace netloc processing_system7_1_M_AXI_GP0 1 1 1 470
preplace netloc processing_system7_1_FCLK_RESET0_N 1 0 3 30 190 480 340 NJ
preplace netloc processing_system7_1_axi_periph_M00_AXI 1 2 1 NJ
preplace netloc processing_system7_1_FCLK_CLK0 1 0 3 20 180 490 320 NJ
preplace netloc S_AXI_HP3_1 1 0 1 NJ
preplace netloc S_AXI_HP1_1 1 0 1 NJ
preplace netloc S_AXI_HP2_1 1 0 1 NJ
preplace netloc processing_system7_1_DDR 1 1 2 NJ 280 NJ
preplace netloc processing_system7_1_FIXED_IO 1 1 2 NJ 300 NJ
preplace netloc rst_processing_system7_1_50M_peripheral_aresetn 1 1 1 500
preplace netloc rst_processing_system7_1_50M_interconnect_aresetn 1 1 1 510
levelinfo -pg 1 0 250 660 830 -top 0 -bot 530
",
}
